...
const purple = [
    ...
    },
    {
        weaponName: "Negev",
        skinName: "Loudmouth",
        prices: [1.03, 0.95, 0.84, 9.52, 9.52, 2.64, 2.85, 2.23, 48.30, 2.85],
        rarity: "purple",
...
const pink = [
    ...
    },
    {
        weaponName: "MP7",
        skinName: "Nemesis",
        prices: [7.93, 7.93, 7.93, 10.82, 21.10, 20.09, 20.09, 20.09, 26.91, 51.17],
        rarity: "pink",
...
const knife = [
    ...
    },
    {
        weaponName: "Falchion Knife",
        skinName: "Night",
        prices: [195.12, 241.52, 219.44, 271.36, 432.14, 213.73, 185.00, 288.14, 263.00, 263.00],
        rarity: "yellow",
    ...
    },
    {
        ...
        prices: [195.48, 205.25, 182.00, 222.20, 546.40, 115.12, 413.03, 214.11, 257.50, 413.03],
        rarity: "yellow",
    ...
    },
    {
        ...
        prices: [266.24, 371.45, 359.68, 552.06, 1318.53, 353.01, 332.39, 397.17, 325.00, 397.17],
        rarity: "yellow",
    ...
    },
    {
        weaponName: "Falchion Knife",
        skinName: "Slaughter",
        prices: [482.43, 482.43, 482.43, 490.76, 593.75, 331.69, 331.69, 331.69, 511.93, 628.85],
        rarity: "yellow",
    ...
    },
    {
        weaponName: "Falchion Knife",
        skinName: "Fade",
        prices: [723.65, 723.65, 723.65, 723.65, 785.19, 275.68, 275.68, 275.68, 275.68, 912.62],
        rarity: "yellow",
